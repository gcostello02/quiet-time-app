        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white shadow-md rounded-xl p-4 max-w-md sm:max-w-xl md:max-w-2xl mx-auto my-6 border border-gray-200">
            ...
            {note.private_notes_content && (
              <div className="mb-4">
                <h2 className="text-base font-semibold text-gray-900 mb-1">Private Notes:</h2>
                <p className="text-sm text-gray-700 whitespace-pre-wrap break-words">
            ...
            {note.private_prayer_content && (
              <div className="mb-4">
                <h2 className="text-base font-semibold text-gray-900 mb-1">Private Prayers:</h2>
                <p className="text-sm text-gray-700 whitespace-pre-wrap break-words">
            ...
            <div className="text-right mb-2">
              <button
                ...
                className="text-indigo-600 hover:text-indigo-800 inline-flex items-center gap-1 bg-white"
              >
